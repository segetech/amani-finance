    ...
    const loadArticle = async () => {
      ...
      try {
        ...
        const mockArticle: Partial<UnifiedContent> = {
          id: id,
          type: 'article',
          title: 'L\'impact de la politique monétaire de la BCEAO sur l\'économie malienne',
          slug: 'impact-politique-monetaire-bceao-economie-mali',
          summary: 'Analyse approfondie des récentes décisions de la Banque Centrale des États de l\'Afrique de l\'Ouest et leur influence sur l\'économie du Mali en 2024.',
...
<p>Le maintien du taux directeur à un niveau relativement bas devrait favoriser l'investissement et la consommation, tout en maintenant une inflation maîtrisée.</p>`,
          ...
          category: 'economie',
          country: 'mali',
          tags: ['BCEAO', 'politique monétaire', 'économie', 'Mali', 'taux directeur'],
          meta_title: 'Impact de la politique monétaire BCEAO sur l\'économie malienne | Amani Finance',
          meta_description: 'Analyse approfondie des récentes décisions de la BCEAO et leur influence sur l\'économie du Mali en 2024.',
          ...
          read_time: 8,
          article_data: {
            excerpt: 'Les récentes décisions de la BCEAO concernant la politique monétaire auront un impact majeur sur l\'économie malienne. Découvrez notre analyse complète.',
            content_type: 'full',
            reading_time: 8,
            is_featured: true,
            related_articles: [],
            sources: ['BCEAO', 'Ministère de l\'Économie du Mali', 'FMI'],
            author_note: 'Article rédigé en collaboration avec des experts de la BCEAO et du secteur bancaire malien.'
          }
        };
  ...
  const handleSave = async (formData: any) => {
    try {
      ...
      error('Erreur', 'Une erreur est survenue lors de la mise à jour de l\'article.');
    }
  };
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200">
          ...
          {article.tags && article.tags.length > 0 && (
            <div className="mt-4">
              <p className="text-sm text-gray-700 mb-2">Étiquettes actuelles :</p>
