...
import { fetchCommoditiesData, CommoditiesData, getCommodityIcon, getCommodityColor } from '../services/commoditiesApi';
...
export default function Indices() {
  ...
  const [selectedCategory, setSelectedCategory] = React.useState<'all' | 'indices' | 'commodities'>('all');
  ...
  const ExplanationCard = ({ title, children, icon: Icon }: { title: string; children: React.ReactNode; icon: any }) => (
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Suivez en temps réel les marchés financiers, indices boursiers et prix des matières premières. 
              Guide complet pour comprendre l'économie africaine et mondiale.
            </p>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <ExplanationCard title="Qu'est-ce qu'un indice boursier ?" icon={BarChart3}>
              <p>
                Un <strong>indice boursier</strong> est comme un thermomètre qui mesure la santé du marché des actions. 
                Il calcule la moyenne des prix de plusieurs entreprises cotées en bourse.
              </p>
              <p>
                <strong>BRVM Composite</strong> : Indice principal de la Bourse Régionale des Valeurs Mobilières, 
                qui regroupe les 8 pays de l'UEMOA (Bénin, Burkina Faso, Côte d'Ivoire, Guinée-Bissau, Mali, Niger, Sénégal, Togo).
              </p>
            </ExplanationCard>

            <ExplanationCard title="Pourquoi suivre les commodités ?" icon={Globe}>
              <p>
                Les <strong>matières premières</strong> (or, pétrole, coton, cacao) sont essentielles pour l'économie africaine. 
                Leurs prix influencent directement :
              </p>
            ...
            <ExplanationCard title="Comment lire les variations ?" icon={TrendingUp}>
              <p>
                <strong className="text-green-600">Vert (+)</strong> : Le prix monte, c'est généralement bon signe pour l'économie du pays exportateur.
              </p>
              <p>
                <strong className="text-red-600">Rouge (-)</strong> : Le prix baisse, cela peut signaler des difficultés économiques.
              </p>
              <p>
                <strong>Pourcentage</strong> : Indique l'ampleur du changement. +2% sur l'or = hausse significative.
              </p>
            </ExplanationCard>

            <ExplanationCard title="Impact sur votre quotidien" icon={Target}>
              <p>
                Ces prix vous affectent directement :
              </p>
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li><strong>Pétrole ↑</strong> = Essence plus chère, transport plus coûteux</li>
                <li><strong>Cacao ↑</strong> = Plus de revenus pour les producteurs ivoiriens</li>
                <li><strong>Or ↑</strong> = Opportunités d'investissement, inflation possible</li>
                <li><strong>Coton ↓</strong> = Difficultés pour les agriculteurs du Mali</li>
              </ul>
            </ExplanationCard>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mb-8">
              ...
              <p className="text-gray-600 text-lg">
                Performance en temps réel de la Bourse Régionale des Valeurs Mobilières
              </p>
            </div>
            ...
            {brvmData?.sectoriels && brvmData.sectoriels.length > 0 && (
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Indices Sectoriels</h3>
      ...
      {/* Matières premières */}
      {(selectedCategory === 'all' || selectedCategory === 'commodities') && commoditiesData && (
        <section className="py-12 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-amani-primary mb-4 flex items-center gap-3">
              ...
              <p className="text-gray-600 text-lg">
                Prix en temps réel des commodités importantes pour l'économie africaine
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-lg">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Guide du débutant</h3>
              <p className="text-gray-600 mb-6">
                Apprenez les bases de l'investissement en bourse et sur les matières premières
              </p>
              <Link 
                to="/guides/debutant" 
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Calculateur d'investissement</h3>
              <p className="text-gray-600 mb-6">
                Simulez vos investissements et calculez les rendements potentiels
              </p>
              <Link 
                to="/calculateur" 
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Analyses d'experts</h3>
              <p className="text-gray-600 mb-6">
                Consultez les analyses et recommandations de nos experts économistes
              </p>
              <Link 
                to="/insights" 
      ...
      <section className="py-8 bg-yellow-50 border-t border-yellow-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="font-semibold text-yellow-800 mb-2">Avertissement sur les risques</h4>
              <p className="text-yellow-700 text-sm">
                Les investissements en bourse et matières premières comportent des risques. 
