...
import { useEconomicData, type EconomicCountry, type RegionalMetric } from "../hooks/useEconomicData";
import {
  BarChart3,
  Plus,
  Edit,
...
export default function EconomicDataManagement() {
  ...
  const [editingItem, setEditingItem] = useState<EconomicIndicator | null>(
    null,
  );
        ...
        <div className="flex items-center justify-center py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md text-center">
            ...
            <p className="text-gray-600 mb-6">
              Vous n'avez pas les permissions nécessaires pour gérer les données
              économiques.
            </p>
            <button
  ...
  const handleDelete = (id: string) => {
    ...
    if (
      item &&
      confirm(`Êtes-vous sûr de vouloir supprimer "${item.name}" ?`)
    ) {
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-6 text-sm text-gray-600">
                          <div className="flex items-center gap-2">
                            ...
                            <div
                              className={`flex items-center gap-1 ${getChangeColor(item.change)}`}
                            >
