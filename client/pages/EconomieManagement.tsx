  ...
  const [sections, setSections] = useState<EconomieSection[]>([
    {
      ...
      content:
        "Suivez l'évolution économique des pays de l'Afrique de l'Ouest avec nos analyses approfondies.",
      position: 1,
      isVisible: true,
      type: "hero",
    ...
    },
    {
      ...
      content:
        "Consultez les principaux indicateurs économiques de la région UEMOA en temps réel.",
      position: 2,
      isVisible: true,
      type: "indicators",
    ...
    },
    {
      ...
      content:
        "Découvrez nos analyses détaillées sur les tendances économiques et leurs impacts.",
      position: 3,
      isVisible: true,
      type: "analysis",
    ...
    },
    {
      ...
      content:
        "Restez informé des dernières actualités économiques qui façonnent notre région.",
      position: 4,
      isVisible: true,
      type: "news",
    ...
    },
    {
      ...
      content:
        "Accédez aux rapports économiques complets sur la performance régionale.",
      position: 5,
      isVisible: true,
      type: "reports",
    ...
    <DashboardLayout
      ...
      actions={
        <div className="flex items-center gap-4">
          ...
          <button className="flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all shadow-lg font-medium">
