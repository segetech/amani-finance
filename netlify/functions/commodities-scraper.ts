...
let commoditiesCache: { data: CommoditiesData; timestamp: number } | null =
  null;
...
const getCommoditiesData = async (): Promise<CommoditiesData> => {
  ...
  if (
    commoditiesCache &&
    Date.now() - commoditiesCache.timestamp < CACHE_DURATION
  ) {
...
const getRealisticCommoditiesData = (): CommoditiesData => {
  ...
  return {
    gold: {
      name: "Or",
      symbol: "XAU/USD",
      price: (2025.5 + variation * 10).toFixed(2),
      currency: "USD",
      change: (variation * 10).toFixed(2),
      changePercent: `${variation >= 0 ? "+" : ""}${(((variation * 10) / 2025.5) * 100).toFixed(2)}%`,
    ...
    platinum: {
      name: "Platine",
      symbol: "XPT/USD",
      price: (985.3 + variation * 20).toFixed(2),
      currency: "USD",
      change: (variation * 20).toFixed(2),
      changePercent: `${variation >= 0 ? "+" : ""}${(((variation * 20) / 985.3) * 100).toFixed(2)}%`,
      isPositive: variation >= 0,
      lastUpdate: now.toISOString(),
      unit: "once troy",
    ...
    oil_wti: {
      name: "Pétrole WTI",
      symbol: "CL",
      price: (78.9 + variation * 1.8).toFixed(2),
      currency: "USD",
      change: (variation * 1.8).toFixed(2),
      changePercent: `${variation >= 0 ? "+" : ""}${(((variation * 1.8) / 78.9) * 100).toFixed(2)}%`,
      isPositive: variation >= 0,
      lastUpdate: now.toISOString(),
      unit: "USD/baril",
    ...
    cocoa: {
      name: "Cacao",
      symbol: "CC",
      price: (3250.8 + variation * 100).toFixed(2),
      currency: "USD",
      change: (variation * 100).toFixed(2),
      changePercent: `${variation >= 0 ? "+" : ""}${(((variation * 100) / 3250.8) * 100).toFixed(2)}%`,
      isPositive: variation >= 0,
      lastUpdate: now.toISOString(),
      unit: "USD/tonne",
